...
An Ansible role for setting up BIND ISC as an **authoritative-only** DNS server for multiple domains on EL7/8 or Ubuntu Server. Specifically, the responsibilities of this role are to:
