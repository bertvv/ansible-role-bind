...
An Ansible role for setting up BIND ISC as an **authoritative-only** DNS server for multiple domains on several Linux distributions. Specifically, the responsibilities of this role are to:
