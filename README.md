...
- **The `netaddr` Python library should be installed on the management node** (since v3.7.0, required for the [`ipaddr`](https://docs.ansible.com/ansible/latest/user_guide/playbooks_filters_ipaddr.html) filter)
